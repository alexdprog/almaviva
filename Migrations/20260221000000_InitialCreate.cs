...
[Migration("20260221000000_InitialCreate")]
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => { table.PrimaryKey("PK_SlotCheckLogs", x => x.Id); });

        migrationBuilder.CreateTable(
            name: "SlotCheckSettings",
            columns: table => new
            {
                Id = table.Column<int>(type: "integer", nullable: false)
                    .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                Url = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                CheckIntervalMinutes = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
                TelegramBotToken = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                TelegramChatId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
            },
            constraints: table => { table.PrimaryKey("PK_SlotCheckSettings", x => x.Id); });
        ...
        migrationBuilder.CreateIndex(name: "IX_SlotCheckLogs_CheckedAt", table: "SlotCheckLogs", column: "CheckedAt");
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "SlotCheckLogs");
        migrationBuilder.DropTable(name: "SlotCheckSettings");
